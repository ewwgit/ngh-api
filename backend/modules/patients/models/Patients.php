    ...
    public function rules()
    {
        return [
           ...
           // [['age'], 'string', 'max' => 10],
        	...
        	[['height','weight','respirationRate','BPLeftArm','BPRightArm','pulseRate','temparatureType','diseases','allergicMedicine','createdDate','patientCompliant', 'createdDate', 'updatedDate', 'countryName', 'stateName', 'patientUniqueId','pId','spo2','aadhar_number'],'safe'],
        ];
    }
